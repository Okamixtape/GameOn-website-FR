        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="max-w-5xl mx-auto relative">
            ...
            <div className="space-y-0">
              ...
              {/* 2026 - Ultimate Challenge - BOSS LEVEL */}
              <TimelineItem
                year="2026"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="group relative">
              ...
              <div className="relative h-full p-8 rounded-3xl bg-[#0a0a1f]/60 backdrop-blur-xl border border-cyan-500/20 group-hover:border-cyan-500/50 group-hover:shadow-[0_0_40px_rgba(0,243,255,0.3)] transition-all">
                ...
                <h3 className="text-2xl mb-4 text-center text-white">PASSION</h3>
            ...
            <div className="group relative">
              ...
              <div className="relative h-full p-8 rounded-3xl bg-[#0a0a1f]/60 backdrop-blur-xl border border-purple-500/20 group-hover:border-purple-500/50 group-hover:shadow-[0_0_40px_rgba(168,85,247,0.3)] transition-all">
                ...
                <h3 className="text-2xl mb-4 text-center text-white">COMMUNAUTÉ</h3>
                <p className="text-gray-400 text-center leading-relaxed">
            ...
            <div className="group relative">
              ...
              <div className="relative h-full p-8 rounded-3xl bg-[#0a0a1f]/60 backdrop-blur-xl border border-cyan-500/20 group-hover:border-cyan-500/50 group-hover:shadow-[0_0_40px_rgba(0,243,255,0.3)] transition-all">
                ...
                <h3 className="text-2xl mb-4 text-center text-white">COMPÉTITION</h3>
                <p className="text-gray-400 text-center leading-relaxed">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="relative p-12 rounded-3xl bg-[#0a0a1f]/60 backdrop-blur-xl border border-cyan-500/30 shadow-[0_0_60px_rgba(0,243,255,0.2)]">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button 
                  size="lg"
                  className="text-lg px-8 py-7 bg-gradient-to-r from-[#ff00ff] via-[#ff0080] to-[#ff00ff] hover:from-[#ff00ff]/90 hover:to-[#ff00ff]/70 text-white border-0 shadow-2xl shadow-pink-500/60 hover:shadow-pink-500/80 transition-all relative group"
                >
                ...
                <Button 
                  size="lg"
                  variant="outline"
                  className="text-lg px-8 py-7 bg-transparent border-2 border-cyan-500/50 text-cyan-400 hover:bg-cyan-500/10 hover:border-cyan-500"
                >
                  VOIR LE TOURNOI
...
function TimelineItem({ year, title, description, icon, iconColor, side, glowColor, isFuture, index = 0 }: TimelineItemProps) {
  ...
  // Zig-zag vertical offset (heartbeat rhythm)
    ...
    >
      ...
      >
        ...
        <div className={`relative p-8 rounded-2xl bg-[#0a0a1f]/80 backdrop-blur-xl border ${colors.border} ${colors.hoverBorder} ${colors.shadow} ${colors.hoverShadow} transition-all duration-300 ${
          ...
          {isFuture && (
            <motion.div 
              className="absolute -top-3 -right-3 px-3 py-1 rounded-full bg-gradient-to-r from-yellow-400 to-orange-500 text-xs uppercase tracking-wider shadow-lg shadow-yellow-500/50"
              animate={{
                y: [0, -2, 0],
              }}
              transition={{
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            {/* Year - Digital Countdown Style */}
            <div className="flex-1">
              <motion.div 
                className={`text-3xl font-mono ${colors.text} tracking-wider relative`}
                style={{
          ...
          {/* Title */}
          <h3 className={`text-2xl mb-3 ${isFuture ? 'text-transparent bg-gradient-to-r from-[#00f3ff] to-[#ff00ff] bg-clip-text' : 'text-white'} tracking-wider uppercase`}>
            {title}
          </h3>
      ...
      >
        {/* Pulse rings for Boss Level node */}
        {isFuture && (
          <>
            <motion.div
  ...
  return (
    <div ref={ref} className="group relative">
      ...
      <div className={`relative h-full p-8 rounded-2xl bg-[#0a0a1f]/60 backdrop-blur-xl border ${colors.border} ${colors.shadow} hover:shadow-2xl transition-all`}>
        ...
        <div className={`text-5xl font-mono mb-2 text-center ${colors.text} tracking-tight`}>
